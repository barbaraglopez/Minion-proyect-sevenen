		...
		<div className="homeContainer flex items-stretch">
			...
			<div className="container p-5">
				...
				<div className="main-container pt-10 pl-20">
					<h2 className="text-3xl">Agregar Comando</h2>
					<div className="grid grid-cols-1">
						<div className="columna-izq">
							<div className="campo mt-10 w-60">
								<p><b>Nombre</b></p>
								<input name="nombre" onChange={handleChange} className="w-56" placeholder="Nombre"></input>
							</div>
							<div className="campo mt-10 w-60">
								<p><b>Descripción</b></p>
								<textarea name="descripcion" onChange={handleChange} className="w-80 h-52 p-1" placeholder="Descripcion breve sobre la utilidad del comando"></textarea>
							</div>
						</div>
					</div>
				</div>
