    ...
    return (
        <div className="containerParametros">
            ...
            <div className="containerLabelInput mb-3">
                ...
                <div className="">
                    <div className="relative w-full h-10 inputContainer">
                        <input
                        ...
                        <button className="boton-primario w-64 text-sm p-2 mt-2 rounded-md font-semibold ">
            ...
            <div className="containerLabelInput">
                ...
                <button className="boton-primario w-64 text-sm p-2 mt-2 rounded-md font-semibold mb-2">
                    Guardar
                </button>
            </div>
        </div>
